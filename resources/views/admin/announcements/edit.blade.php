        ...
        <form action="{{ route('announcements.update', $announcement->id) }}" method="POST" class="p-8 space-y-6">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title', $announcement->title) }}" 
                       class="w-full px-4 py-3 rounded-lg border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 transition-all duration-200 outline-none @error('title') border-red-500 @enderror" required>
